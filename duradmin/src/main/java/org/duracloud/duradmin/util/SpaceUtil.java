...
public class SpaceUtil {
    ...
    public static Space populateSpace(Space space, org.duracloud.domain.Space cloudSpace)
    throws Exception {
    ...
    throws Exception{
        ...
        spaceMetadata.setCreated(
            spaceProps.get(ContentStore.SPACE_CREATED));
        spaceMetadata.setCount(
            spaceProps.get(ContentStore.SPACE_COUNT));
        spaceMetadata.setAccess(
            spaceProps.get(ContentStore.SPACE_ACCESS));
