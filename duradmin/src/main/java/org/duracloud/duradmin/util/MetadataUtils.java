...
public class MetadataUtils {
    ...
    public static void setMetadata(ContentStore contentStore, String spaceId,
                               String contentId,
    ...
    public static Map<String, String> getMetadata(ContentStore contentStore, String spaceId, String contentId) throws ContentStoreException{
          if(StringUtils.hasText(contentId)){
        ...
        if(extendedMetadata != null){
            for(String name : metadata.keySet()){
                if(name.startsWith(NAME_KEY_PREFIX)){
                    extendedMetadata.add(new NameValuePair(name.substring(NAME_KEY_PREFIX.length()), metadata.get(name)));
                }
            }
        }
