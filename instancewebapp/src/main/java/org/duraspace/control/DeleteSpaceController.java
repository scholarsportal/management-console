...
public class DeleteSpaceController extends SimpleFormController {
    ...
    throws Exception {
        ...
        if(accountId == null || accountId.equals("")) {
            throw new Exception("Account ID must be provided in order to delete a space.");
        }

        if(spaceId == null || spaceId.equals("")) {
            throw new Exception("Space ID must be provided in order to delete a space.");
        }
