 ...
 */
@Path("/service")
public class ComputeRest extends BaseRest {
    ...
    public Response getServiceSubscriptions(@PathParam("customerID")
                                            String customerID) {
        String xml = ComputeResource.getServiceSubscriptions(customerID);
        return Response.ok(xml, TEXT_XML).build();
    }
    ...
    public Response getServiceConfiguration(@PathParam("customerID")
                                            ...
                                            @PathParam("serviceID")
                                            String serviceID) {
        String xml = ComputeResource.getServiceConfiguration(customerID, serviceID);
        return Response.ok(xml, TEXT_XML).build();
    }
    ...
    public Response addServiceSubscription(@PathParam("customerID")
        ...
        ComputeResource.addServiceSubscription(customerID, serviceID, configurationXML);
    ...
    public Response updateServiceConfiguration(@PathParam("customerID")
                                               ...
                                               String serviceID) {
        String configurationXML = getRequestXML();
        ComputeResource.updateServiceConfiguration(customerID, serviceID, configurationXML);
    ...
    public Response removeServiceSubscription(@PathParam("customerID")
                                              ...
                                              @PathParam("serviceID")
                                              String serviceID) {
        ComputeResource.removeServiceSubscription(customerID, serviceID);
    ...
    private String getRequestXML() {
        try {
            ...
            log.error("Could not retrieve XML content from request: " +
                         e.getMessage());
            return null;
        }
    }
