...
public class MockContentStoreManagerFactoryImpl implements ContentStoreManagerFactory{
	@Override
	public ContentStoreManager create() throws Exception {
		return new MockContentStoreManager();
	}

	private class MockContentStoreManager implements ContentStoreManager {
	...
	private class MockContentStore implements ContentStore{
		...
		public String addContent(String spaceId, String contentId,
				InputStream content, long contentSize,
				String contentMimeType, Map<String, String> contentMetadata)
				throws ContentStoreException {
			// TODO Auto-generated method stub
			return null;
		}
