...
call mvn install:install-file -Dfile=../libs/emcesu-1.2.0.90.jar -DgroupId=com.emc -DartifactId=emcesu -Dversion=1.2.0.90 -Dpackaging=jar
...
call mvn install:install-file -Dfile=../libs/com.springsource.org.apache.derby-10.5.1000001.764942-duracloud.jar -DgroupId=org.apache.derby -DartifactId=com.springsource.org.apache.derby -Dversion=10.5.1000001.764942-duracloud -Dpackaging=jar
