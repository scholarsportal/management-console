...
public class InstanceConfigUtilImpl implements InstanceConfigUtil {
    ...
    public DuraserviceConfig getDuraserviceConfig() {
        ...
        ServerImage image =
            repoMgr.getServerImageRepo().findOne(instance.getImage().getId());
        ...
        ServiceRepository serviceRepo = repoMgr.getServiceRepositoryRepo()
                .findByVersionAndServicePlan(imageVersion, servicePlan);
