...
//    private DuraCloudAcctRepositoryFileImpl repo;
//
//    private final String testRepoLoc =
//            "src/test/java/org/duracloud/mainwebapp/domain/repo/test-repo.xml";
//
//    private final int NUM_ACCTS = 3;
//
//    private Properties custAcctProps;
//
//    private DuraCloudAcct custAcct0;
//
//    private DuraCloudAcct custAcct1;
//
//    private DuraCloudAcct custAcct2;
//
...
//        custAcct0 = new DuraCloudAcct();
//        custAcct1 = new DuraCloudAcct();
//        custAcct2 = new DuraCloudAcct();
//
//        repo = new DuraCloudAcctRepositoryFileImpl();
...
//        custAcct0.setDuracloudCredential(credential0);
//        custAcct0.setUsers(users);
//        custAcct0.setId(id0);
//
//        custAcct1.setComputeAcctId(computeAcctId1);
//        custAcct1.setDuracloudCredential(credential1);
//        custAcct1.setUsers(users);
//        custAcct1.setId(id1);
//
//        custAcct2.setComputeAcctId(computeAcctId2);
//        custAcct2.setDuracloudCredential(credential2);
//        custAcct2.setUsers(users);
//        custAcct2.setId(id2);
//
//        // Build the actual repository.
//        custAcctProps.setProperty(DuraCloudAcctRepositoryFileImpl.REPO_LOCATION,
//                                  testRepoLoc);
//        repo.setProperties(custAcctProps);
//
//        repo.saveDuraCloudAcct(custAcct0);
//        repo.saveDuraCloudAcct(custAcct1);
//        repo.saveDuraCloudAcct(custAcct2);
//    }
//
//    @After
...
//
//        DuraCloudAcct acct = repo.findDuraCloudAcct(entryCred);
//        assertNotNull(acct);
//
//        Credential cred = acct.getDuracloudCredential();
//        assertNotNull(cred);
//
...
//                   numAccts == NUM_ACCTS);
//
//        assertNotNull(repo.findDuraCloudAcct(credential0));
//        assertNotNull(repo.findDuraCloudAcct(credential1));
//        assertNotNull(repo.findDuraCloudAcct(credential2));
//
//    }
//
//    @Test
...
//        verifyInitialRepoContents();
//
//        DuraCloudAcct acct = createCustomerAcct();
//
//        verifyNewAcctNotExist(acct.getDuracloudCredential());
//
//        repo.saveDuraCloudAcct(acct);
//
//        verifyNewAcctAdded(acct.getDuracloudCredential());
//    }
//
//    private DuraCloudAcct createCustomerAcct() {
//        DuraCloudAcct acct = new DuraCloudAcct();
//
...
//        acct.setDuracloudCredential(credentialNEW);
//        acct.setUsers(users);
//        return acct;
//    }
//
...
//        assertNotNull(repo.findDuraCloudAcct(credential2));
//
//        assertNotNull(repo.findDuraCloudAcct(cred));
//    }
