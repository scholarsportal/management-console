...
import org.duracloud.aitsync.queue.TransferTaskQueue;
import org.duracloud.aitsync.repo.ArchiveItResource;
import org.duracloud.aitsync.repo.RemoteRepo;
import org.duracloud.aitsync.repo.Resource;
import org.duracloud.aitsync.test.Utils;
import org.duracloud.aitsync.watch.RepoWatcherImpl;
import org.duracloud.aitsync.watch.WatchState;
import org.duracloud.aitsync.watch.WatchStateManager;
...
public class TransferTaskQueueFeederImplTest {
    ...
    public void testFetchAndFeed() throws Exception {
        ...
        RepoWatcherImpl f =
            new RepoWatcherImpl(mappingManager,
                                            watchStateManager,
                                            remoteRepo,
                                            queue);
