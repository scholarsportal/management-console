...
call pax-import-bundle -g org.duracloud.services -a servicesutil -v 0.4.0-SNAPSHOT -- -DimportTransitive -DwidenScope
...
call mvn clean -f pom-run.xml pax:provision
